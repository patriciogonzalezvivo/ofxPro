...
public:
    ...
    ofPoint untransform(const ofPoint &point) {
    ...
    static Transformation deriveTransformation(const double &a1x, const double &a1y,
        ...
        const ofPoint d = linearSolution( a1x, a1y, a2x,
                                       b1x, b1y, b2x,
                                       c1x, c1y, c2x );
        
        const ofPoint e = linearSolution( a1x, a1y, a2y,
                                       b1x, b1y, b2y,
                                       c1x, c1y, c2y );
    ...
    //
    static ofPoint linearSolution(const double &r1, const double &s1, const double &t1,
