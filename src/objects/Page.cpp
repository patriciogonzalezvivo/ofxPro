    ...
    if (bChange){
        ...
        for(int j = 0; j < height; j += meshDefinition) {
            for(int i = 0; i < width; i += meshDefinition) {
                ...
                //  texCoords
                //
                ofPoint a = ofPoint(i,j,0);
                ofPoint b = ofPoint(i+meshDefinition,j,0);
                ofPoint c = ofPoint(i+meshDefinition,j+meshDefinition,0);
                ofPoint d = ofPoint(i,j+meshDefinition,0);
