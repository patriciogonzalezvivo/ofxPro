<?php
        ...
        $command = "raspistill -t 0 -n".$width.$height.$quality.$sharpness.$contrast.$brightness.$saturation.$exposure.$awb.$imxfx.$colfx.$metering.$rotation.$hflip.$vflip." -o image.jpg";
